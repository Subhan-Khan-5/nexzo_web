...
export default function AboutHeroSection({
  headline = "We're not here to impress you with buzzwords.",
  description = "We're here to build systems that solve real problems—the kind that keep you up at night or cost hours of your team's time every week.",
  primaryButtonText = "Get Your Free Audit",
  primaryButtonLink = "#",
  secondaryButtonText = "See How We Work",
  secondaryButtonLink = "#",
