interface WhyAutomationsFailSectionProps {
  title: string;
  subtitle?: string;
  introText?: string;
  items: string[];
...
export default function WhyAutomationsFailSection({
  title,
  subtitle,
  introText,
  items,
}: WhyAutomationsFailSectionProps) {
  return (
...
{/* <div className="absolute w-[70%] top-[0] left-[16%]"><img src="/images/backgroundgrid.svg" className=" w-[100%] h-[70%] " alt="Why Automations Fail" /></div>
<div className="absolute w-[70%] h-[180px] top-[72%] left-[15.9%]"><img src="/images/backgroundgrid.svg" className="object-cover w-[100%] h-[70%] " alt="Why Automations Fail" /></div> */}
      {/* <img src="/images/backgroundgrid.svg" className="absolute top-[-5vh] left-[15%] w-[70vw] h-[80vh] " alt="Why Automations Fail" /> */}
      <div className="relative z-10  min-w-[350px]  mx-auto">
        ...
        {/* Main Content Box */}
        <div className="bg-gradient-to-br to-[#74888f] min-w-[350px] sm:min-w-[450px] md:min-w-[550px] lg:min-w-[650px] xl:min-w-[750px] 2xl:min-w-[850px]
           from-[#cee6ee] backdrop-blur-sm rounded-2xl px-8 py-10 md:px-12 md:py-14 shadow-lg">
          {/* Subtitle */}
          {subtitle && (
