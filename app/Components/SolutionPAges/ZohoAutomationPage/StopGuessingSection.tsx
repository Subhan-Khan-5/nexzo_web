...
export default function StopGuessingSection({
  ...
  return (
    <section className="relative mt-[10vh] px-2 min-w-[380px] w-full mx-auto md:px-6 md:px-[7.5vw] bg-white">
      ...
      <div className="absolute  bg-cover bg-center h-[40vh] top-[50%] -translate-y-1/2 right-[0] z-0" > <img src="/images/grid2.png" alt="grid"  /> </div>
    <div className="absolute  bg-cover bg-center h-[40vh] top-[70%] -translate-y-1/2 left-[0] z-0" > <img src="/images/grid2.png" alt="grid"  /> </div>
